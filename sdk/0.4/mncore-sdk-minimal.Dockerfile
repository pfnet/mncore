...
# Dockerfile to build the MN-Core SDK 0.4 minimal Docker image (mncore-sdk-minimal:0.4).
...
ARG torch_index_url=https://download.pytorch.org/whl/cpu-cxx11-abi/
ARG torch_version=2.6.0+cpu.cxx11.abi
ARG torchvision_github_release=v0.21.0
ARG torchvision_version=0.21.0+gcc10cpu
...
# MN-Core SDK 0.4 has been confirmed to work only in the Python environment constructed as shown below.
...
RUN rm /usr/lib/python3.12/EXTERNALLY-MANAGED && \
    ...
    "torch==${torch_version}" \
    "https://github.com/pfnet/torchvision/releases/download/${torchvision_github_release}/torchvision-${torchvision_version}-cp312-cp312-linux_x86_64.whl" \
