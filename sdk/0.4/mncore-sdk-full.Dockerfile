...
# Dockerfile to build the MN-Core SDK 0.4 full Docker image (mncore-sdk-full:0.4) based on mncore-sdk-minimal:0.4.

# The ref of your own mncore-sdk-minimal:0.4 image, which is built from mncore-sdk-minimal.Dockerfile.
...
#
# NOTE: The "--build-arg" option specifies the base minimal image. You have to replace this "mncore-sdk-minimal:0.4"
