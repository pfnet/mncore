...
# Dockerfile to build the MN-Core SDK 0.7 minimal Docker image (mncore-sdk-minimal:0.7).
...
# MN-Core SDK 0.7 has been confirmed to work only in the Python environment constructed as shown below.
