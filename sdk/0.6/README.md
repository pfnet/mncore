...
* English: https://dev.mn-core.com/sdk/0.6/MLSDK/docs/en/
* 日本語: https://dev.mn-core.com/sdk/0.6/MLSDK/docs/ja/

Dockerfiles
------------

This directory contains Dockerfiles to build your own MN-Core SDK 0.6 Docker images.
...
MN-Core with `mncore-sdk-full:0.6` in a container on a bare metal machine.
...
```bash
$ bash create_dev_ctr.sh -R podman -i localhost/mncore-sdk-full:0.6 -A
```
...
* `-i IMAGE[:TAG]`: Use a specific Docker image instead of `mncore-sdk-full:0.6`
