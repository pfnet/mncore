...
# Dockerfile to build the MN-Core SDK 0.6 minimal Docker image (mncore-sdk-minimal:0.6).
...
# MN-Core SDK 0.6 has been confirmed to work only in the Python environment constructed as shown below.
