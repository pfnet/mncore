...
* English: https://dev.mn-core.com/sdk/0.8/MLSDK/docs/en/
* 日本語: https://dev.mn-core.com/sdk/0.8/MLSDK/docs/ja/

Dockerfiles
------------

This directory contains Dockerfiles to build your own MN-Core SDK 0.8 Docker images.

```
# Build mncore-sdk-minimal:0.8.
$ docker build -t mncore-sdk-minimal:0.8 -f mncore-sdk-minimal.Dockerfile .

# Build mncore-sdk-full:0.8 based on mncore-sdk-minimal:0.8.
$ docker build -t mncore-sdk-full:0.8 -f mncore-sdk-full.Dockerfile --build-arg minimal_image_ref=mncore-sdk-minimal:0.8 .
```
...
```sh
# Build mncore-sdk-minimal:0.8.
$ podman build -t mncore-sdk-minimal:0.8 -f mncore-sdk-minimal.Dockerfile .

# Build mncore-sdk-full:0.8 based on mncore-sdk-minimal:0.8.
$ podman build -t mncore-sdk-full:0.8 -f mncore-sdk-full.Dockerfile --build-arg minimal_image_ref=localhost/mncore-sdk-minimal:0.8 .
```
...
MN-Core with `mncore-sdk-full:0.8` in a container on a bare metal machine.
...
```bash
$ bash create_dev_ctr.sh -R podman -i localhost/mncore-sdk-full:0.8 -A
```
...
* `-i IMAGE[:TAG]`: Use a specific Docker image instead of `mncore-sdk-full:0.8`
