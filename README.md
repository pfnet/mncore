...
* [`sdk/0.8/README.md`](sdk/0.8/README.md)
...
If you have access to an MN-Core 2 Devkit or MN-Server 2, you can run programs on actual MN-Core hardware instead of the emulator. These systems allow you to execute programs within a Docker container built using the instructions in [`sdk/0.8/README.md`](sdk/0.8/README.md).
...
You can use pre-built Docker images on PFCP that are equivalent to images built with [`sdk/0.8/README.md`](sdk/0.8/README.md).
...
* `sdk/` -- MN-Core SDK
  * `0.4/`, `0.5/`, `0.6/`, `0.7/`, `0.8/` -- MN-Core SDK versions. Each contains:
